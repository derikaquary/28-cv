      ...
      <div>
        <Carousel autoSlide={true}>
          <div className="flex flex-col items-center mt-3 space-y-2 ">
            <div
              className={`rounded-xl bg-menu h-[150px] w-[200px] bg-center bg-cover`}></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div
              className={`rounded-xl bg-menu2 h-[150px] w-[200px] bg-center bg-cover`}></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div
              className={`rounded-xl bg-order h-[150px] w-[200px] bg-center bg-cover`}></div>
