  ...
  return (
    <div
      ...
      <div data-aos="fade-right" data-aos-duration={1000}>
        <Link
          href="https://warung-ummu-yassir.vercel.app/"
          target="_blank"
      ...
      <div>
        <div
          ...
          className={`rounded-xl bg-ummu h-[200px] bg-cover bg-center sm:h-[400px] sm:w-[650px]`}></div>
      ...
      <div>
        <Carousel autoSlide={true}>
          <div className="flex flex-col items-center mt-3 space-y-2 ">
            <div
              className={`rounded-xl bg-menu h-[150px] w-[200px] bg-center bg-cover sm:h-[300px] sm:w-[650px]`}></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div
              className={`rounded-xl bg-menu2 h-[150px] w-[200px] bg-center bg-cover sm:h-[300px] sm:w-[650px]`}></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div
              className={`rounded-xl bg-order h-[150px] w-[200px] bg-center bg-cover sm:h-[300px] sm:w-[650px]`}></div>
