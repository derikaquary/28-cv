...
function Oasis() {
  return (
    <div
      id="cyan"
      className="flex flex-col items-center justify center h-[100vh] w-[300px] px-3 gap-5">
      <div>
        <div className="bg-oasis h-[200px] bg-cover bg-center"></div>
      ...
      <div>
        <Carousel autoSlide={true}>
          <div className="flex flex-col items-center mt-3 space-y-2 ">
            <div className="bg-cabins h-[150px] w-[200px] bg-center bg-cover"></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div className="bg-reserve h-[150px] w-[200px] bg-center bg-cover"></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div className="bg-guest h-[150px] w-[200px] bg-center bg-cover"></div>
            <p className="text-white text-sm ">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Adipisci, animi repellendus ab quos quidem illum esse, libero
              maiores omnis at repudiandae, obcaecati odit magni eum quod. Eos
