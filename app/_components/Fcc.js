      ...
      <div>
        <Carousel autoSlide={true}>
          <div className="flex flex-col items-center mt-3 space-y-2 ">
            <div className="rounded-xl bg-makanan h-[150px] w-[200px] bg-center bg-cover"></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div className="rounded-xl bg-artMakanan h-[150px] w-[200px] bg-center bg-cover"></div>
          ...
          <div className="flex flex-col items-center text-justify mt-3  space-y-2">
            <div className="rounded-xl bg-contMakanan h-[150px] w-[200px] bg-center bg-cover"></div>
            <p className="text-white text-sm ">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Adipisci, animi repellendus ab quos quidem illum esse, libero
              maiores omnis at repudiandae, obcaecati odit magni eum quod. Eos
