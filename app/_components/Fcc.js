    ...
    <div
      ...
      <div>
        <div
          ...
          className={`bg-center bg-cover rounded-xl bg-fcc h-[200px] sm:h-[400px] sm:w-[650px]`}></div>
      ...
      <div>
        <Carousel autoSlide={true}>
          <div className="flex flex-col items-center mt-3 space-y-2">
            <div
              className={`bg-center bg-cover rounded-xl bg-makanan h-[150px] w-[200px] sm:h-[300px] sm:w-[650px]`}></div>
          ...
          <div className="flex flex-col items-center mt-3 space-y-2 text-justify">
            <div
              className={`bg-center bg-cover rounded-xl bg-artMakanan h-[150px] w-[200px] sm:h-[300px] sm:w-[650px]`}></div>
          ...
          <div className="flex flex-col items-center mt-3 space-y-2 text-justify">
            <div
              className={`bg-center bg-cover rounded-xl bg-contMakanan h-[150px] w-[200px] sm:h-[300px] sm:w-[650px]`}></div>
